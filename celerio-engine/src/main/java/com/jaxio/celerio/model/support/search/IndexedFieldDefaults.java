...
public class IndexedFieldDefaults {
    public static String name = "";
    public static Store store = Store.NO;
    public static Boolean index = Boolean.TRUE;
    public static Analyze analyze = Analyze.YES;
    public static Norms norms = Norms.YES;
    public static TermVector termVector = TermVector.NO;
}