...
public class SimpleOneToOne extends SimpleRelation {

    public SimpleOneToOne(Namer fromNamer, Namer toNamer, Attribute fromAttribute, Entity fromEntity, Entity toEntity, Attribute toAttribute) {
    ...
    public String toString() {
        ...
        sb.append(getFromAttribute().getFullName());
        sb.append(" ==> ");
